...
export default async function ArticlePage({ params }) {
  ...
  return <main data-no-translate lang="az" className={styles.directory}>
    ...
    <nav className={styles.articleNav} aria-label="Əsas menyu"><Link className={styles.brand} href="/">asimos<span>↗</span></Link><Link href="/karyera-meslehetleri">Karyera məsləhətləri</Link><Link href="/vakansiyalar">İş elanları ↗</Link></nav>
