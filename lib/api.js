...
export const api = {
  ...
  getSiteStats: () => request("/site-stats"),
  ...
  aiGenerateJob: (payload) => request("/ai/generate-job", { method: "POST", body: payload }),
  aiImproveJob: (payload) => request("/ai/improve-job", { method: "POST", body: payload }),
  aiSuggestCategory: (payload) => request("/ai/suggest-category", { method: "POST", body: payload }),
  aiMatchJobs: (payload) => request("/ai/match-jobs", { method: "POST", body: payload }),
  aiProfileBio: (payload) => request("/ai/profile-bio", { method: "POST", body: payload }),
  aiSupportReply: (payload) => request("/ai/support-reply", { method: "POST", body: payload }),
  aiCheckJobRisk: (payload) => request("/ai/check-job-risk", { method: "POST", body: payload }),
};
